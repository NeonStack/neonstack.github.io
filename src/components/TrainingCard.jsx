...
const TrainingCard = ({ title = "", provider = "", shortDesc = "", srcImg = "", verifyAt = "" }) => {
    return (
        <div className="bg-background flex flex-col gap-5 p-7 shadow-xl rounded-lg w-full max-w-96 h-full lg:w-[29%] flex-shrink-0 flex-grow-0 animate-fadeIn" >
            ...
            <div className="flex flex-wrap gap-5 items-center justify-center mt-auto">
