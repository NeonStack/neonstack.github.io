...
export default function App() {
  ...
  return (
    <>
      ...
      <main>
        <section
          className='lg:bg-background-alt p-0 lg:p-10 min-h-[100vh]'
          id='parentHero'
          ...
          >
            <div className='flex flex-col mt-[4rem] lg:flex-row lg:gap-7'>
              <div className='lg:flex lg:flex-col lg:gap-7 lg:w-[60%]'>
                <div id='aboutme1'>
                  <Hero className='lg:pt-10 lg:rounded-2xl lg:h-full lg:shadow-lg lg:border lg:border-background-alt lg:bg-background component1' />
                </div>
                <div className='lg:flex lg:flex-row lg:gap-7'>
                  <div className='lg:w-1/2' id='aboutme2'>
                    <AboutMe className='lg:rounded-2xl lg:h-full lg:shadow-lg lg:border lg:border-background-alt lg:bg-background component2' />
                  </div>
                  <div className='lg:w-1/2' id='education'>
                    <Education className='lg:rounded-2xl lg:h-full lg:shadow-lg lg:border lg:border-background-alt lg:bg-background component3' />
                  </div>
                </div>
              </div>
              <div className='lg:w-[40%]' id='skills'>
                <Skills className='lg:rounded-2xl lg:h-full lg:shadow-lg lg:border lg:border-background-alt lg:bg-background component4' />
              </div>
            </div>
          </Suspense>
        </section>
        ...
        >
          <div id="certificates" onViewportEnter={handleViewportUpdate}>
            <Certificates />
          </div>
        </Suspense>
        <Suspense
