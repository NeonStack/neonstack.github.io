...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center bg-primary shadow-md p-5 px-10 fixed w-full z-50 top-0 max-h-20">
      ...
      {/* mobile opened menu*/}
      <div className={`flex bg-primary shadow-md absolute w-[100%] h-[100vh] justify-center items-center z-50 top-0 lg:hidden ease-in-out duration-300 ${showMenu ? 'right-[0%]' : 'right-[-110%]'}`}>
        {/* close btn */}
